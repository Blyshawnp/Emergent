...
if (-not (Test-Path -LiteralPath (Join-Path $samDist 'win-unpacked\Smart Alert Manager.exe'))) {
  $missingBuilds += 'desktop/dist-notification-manager/win-unpacked/Smart Alert Manager.exe'
}
