...
function Is-Protected {
  ...
  if ($name -in @('google-service-account.json', 'service-account.json', 'runtime_config.json', 'server.py', 'packaged_backend.py', 'package.json', 'package-lock.json', 'yarn.lock')) {
    return $true
  }
