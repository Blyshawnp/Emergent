...
const api = {
  ...
  getSamUserManagementList: (callerAuthUid, accessToken = null) => request('POST', '/sam/admin/users/list', { caller_auth_uid: callerAuthUid, access_token: accessToken }, 15000),
  setSamUserActive: (callerAuthUid, targetUserId, active, accessToken = null) => request('POST', '/sam/admin/users/set-active', { caller_auth_uid: callerAuthUid, target_user_id: targetUserId, active, access_token: accessToken }, 15000),
  updateSamUser: (callerAuthUid, targetUserId, updates, accessToken = null) => request('POST', '/sam/admin/users/update', { caller_auth_uid: callerAuthUid, target_user_id: targetUserId, ...updates, access_token: accessToken }, 15000),
  enrollSamUser: (callerAuthUid, targetUserId, accessToken = null) => request('POST', '/sam/admin/users/enroll', { caller_auth_uid: callerAuthUid, target_user_id: targetUserId, access_token: accessToken }, 15000),
  sendSamUserPasswordReset: (email) => request('POST', '/sam/admin/users/send-reset', { email }, 15000),
