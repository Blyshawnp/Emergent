...
export default function TutorialPreviewOverlay({
  ...
  const baseSteps = useMemo(() => ([
    ...
    },
    {
      ...
      content: 'Basics collects candidate details and required pre-checks before scoring starts. Shared candidate lookup waits for a stronger name entry. Confirm Correct Candidate before loading prior Basics, final-attempt warnings, or withdrawn blocks.',
      placement: 'bottom',
    },
    {
      id: 'basics-headset',
    ...
    },
    {
      ...
      content: 'Use NC/NS, Not Ready, and Tech Issue only when that outcome applies. Unresolved tech issues preserve the session and route to Review when the session must end.',
      placement: 'top',
    },
    {
      id: 'calls-setup',
    ...
    },
    {
      ...
      content: 'History stores recent sessions tested on this local app/user. Shared Google Sheet lookup remains separate for older and cross-tester candidate records.',
      placement: 'center',
    },
    {
      id: 'settings-page',
