...
const HELP_TOPICS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      'Select a template to preview the full post on the right with notes and any configured screenshot preview, then use Copy.',
      ...
      'Templates, screenshots, shortcut behavior, automatic copy, confirmation toast, and favorite shortcut assignments are managed in Settings.',
    ],
  },
  {
    ...
    bullets: [
      ...
      'Preview: selecting a post shows the full message, notes, copy action, and any configured screenshot preview.',
