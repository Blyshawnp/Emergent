...
function DiscordTab({ s, set }) {
  ...
  return (
    <div className="card" data-testid="settings-discord">
      ...
      <p className="text-muted text-sm" style={{ marginBottom: 16 }}>Screenshots with titles that can be copied to clipboard from the Discord panel. Upload an image file to store it with your settings and preview it here.</p>
