...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  installCredential: {
    getStatus: () => ipcRenderer.invoke('installCredential:getStatus'),
    save: (credData) => ipcRenderer.invoke('installCredential:save', credData),
    clear: () => ipcRenderer.invoke('installCredential:clear'),
  },
