...
| SS-MTS-03 | Basics / readiness | Prevent readiness mistakes | Final Attempt; Brand / Model; USB; Noise Cancelling Mic; Has VPN; Can turn off; VPN / Proxy Lookup Sites; Browser Checklist | Synthetic headset/IP; show three manual Copy Link rows and no lookup result | `basics`, `headset-lookup` | MTS Quick Start; Candidate Lookup/Basics | Priority recapture after manual-only VPN correction |
